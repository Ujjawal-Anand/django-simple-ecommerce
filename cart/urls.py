...
urlpatterns = [
    ...
    path('decrease-quantity/<pk>', views.DecreaseQuantityView.as_view(), name='decrease-quqnatity'),
    path('remove-from-cart/<pk>', views.RemoveFromCartView.as_view(), name='remove-form-cart'),
]